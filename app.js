...
//Details other pages animations
function detailAnimation() {
    ...
    slides.forEach((slide, index, slides) => {
        ...
        const nextP = nextSlide.querySelector('.fashion-text');
        slidesTl.fromTo(slide, { opacity: 1 }, { opacity: 0 })
        slidesTl.fromTo(nextSlide, { opacity: 0 }, { opacity: 1 }, '-=1')
        slidesTl.fromTo(nextImg, { x: '100%' }, { x: '0%' }, '-=0.5')
        slidesTl.fromTo(nextP, { x: '-100%' }, { x: '0%' }, '-=0.5')
        //Scene
...
//Event listeners for mouse and anavbar
